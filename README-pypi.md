...
| MCP server for agent integration | **Yes** (12 tools; Claude Desktop via stdio, Claude Code via SSE, n8n/LangGraph via HTTP/SSE; brain+memory architecture — Claude reasons and edits, Synthadoc persists with immutable audit trail; no double-LLM cost for read operations) — [design](https://github.com/axoviq-ai/synthadoc/blob/main/docs/design.md#27-mcp-server) · [quick-start](https://github.com/axoviq-ai/synthadoc/blob/main/docs/user-quick-start-guide.md#appendix-i--connect-claude-via-mcp) | No          | No         | No        |
